...
NB = pathlib.Path("notebooks/lineas_tematicas/bloque_a_gestion/predios_conservacion.ipynb")
...
cells.insert(idx_seasonal + 1, ahp_md)
cells.insert(idx_seasonal + 2, ahp_code)
