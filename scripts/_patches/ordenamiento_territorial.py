"""Enrichment ordenamiento_territorial: EEP, IACAL, SARAR."""
...
def apply(nb: dict) -> None:
    ...
    insert_after(cells, find_data(cells), [eep_md, eep_code])
    insert_after(cells, find_seasonal(cells), [iacal_md, iacal_code])
