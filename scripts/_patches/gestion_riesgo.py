"""Enrichment gestion_riesgo: AVR, IVET, SPI, vulnerabilidad, LSTM proxy."""
...
def apply(nb: dict) -> None:
    ...
    insert_after(cells, find_data(cells), [avr_md, avr_code])
    insert_after(cells, find_seasonal(cells), [avr_viz_md, avr_viz_code])
    insert_after(cells, find_mk(cells), [lstm_md, lstm_code])
