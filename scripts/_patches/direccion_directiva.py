"""Enrichment direccion_directiva: DPSIR, ICAU, IEDI, Isolation Forest."""
...
def apply(nb: dict) -> None:
    ...
    insert_after(cells, find_data(cells), [dpsir_md, dpsir_code])
    insert_after(cells, find_seasonal(cells), [icau_md, icau_code])
    insert_after(cells, find_rank(cells), [if_md, if_code])
