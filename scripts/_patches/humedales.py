"""Enrichment humedales: OD, estado trofico, Vollenweider, BMWP-Col, NDWI."""
...
def apply(nb: dict) -> None:
    ...
    insert_after(cells, find_data(cells), [trofico_md, trofico_code])
    insert_after(cells, find_seasonal(cells), [bio_md, bio_code])
